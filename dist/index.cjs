...
var GeofenceModal = ({ geofence, onClose }) => {
  return /* @__PURE__ */ React2__default.default.createElement("article", { className: "w-[200px] flex flex-col gap-2" }, /* @__PURE__ */ React2__default.default.createElement("div", { className: "bg-black text-white rounded-[5rem] text-center py-2" }, /* @__PURE__ */ React2__default.default.createElement("h2", { className: "font-bold text-[13px]" }, "Nombre"), /* @__PURE__ */ React2__default.default.createElement("p", { className: "text-[12px]" }, geofence.geofenceName)), /* @__PURE__ */ React2__default.default.createElement("div", { className: "flex gap-4 py-1 justify-center bg-black text-white text-[13px] rounded-2xl text-center items-center" }, /* @__PURE__ */ React2__default.default.createElement(iconsReact.IconMapPinFilled, { size: 22 }), /* @__PURE__ */ React2__default.default.createElement("p", { className: "text-[14px]" }, geofence.geofenceLocation)), /* @__PURE__ */ React2__default.default.createElement("div", { className: "bg-black rounded-2xl py-2 text-white text-center" }, /* @__PURE__ */ React2__default.default.createElement("h2", { className: "font-bold text-[13px]" }, "Tarifa inicial"), /* @__PURE__ */ React2__default.default.createElement("p", { className: "text-[12px]" }, "$", geofence.initialRate, " MXN km")), /* @__PURE__ */ React2__default.default.createElement("div", { className: "bg-black py-2 text-white rounded-[1.5rem] text-center flex flex-col gap-1" }, /* @__PURE__ */ React2__default.default.createElement("h2", { className: "font-bold text-[13px]" }, "Tarifa din\xE1mica"), /* @__PURE__ */ React2__default.default.createElement("p", { className: "text-[12px]" }, "$", geofence.dynamicRateMinPrice, " MXN ", /* @__PURE__ */ React2__default.default.createElement("span", null, "->"), " ", geofence.dynamicRateMaxDistance, " km"), /* @__PURE__ */ React2__default.default.createElement("p", { className: "text-[12px]" }, "$50 MXN - 9PM a 5AM")), /* @__PURE__ */ React2__default.default.createElement("div", { className: "flex gap-1 justify-between h-[40px] w-full" }, /* @__PURE__ */ React2__default.default.createElement("div", { className: "bg-black flex items-center justify-center w-[60px] rounded-[50px]" }, /* @__PURE__ */ React2__default.default.createElement(Switch_default, { initialOn: geofence.on || false })), /* @__PURE__ */ React2__default.default.createElement("div", { className: "bg-black p-1 rounded-full flex items-center" }, /* @__PURE__ */ React2__default.default.createElement(
    "div",
    {
      className: "w-[30px] h-[30px] rounded-full",
      style: { backgroundColor: geofence.geofenceColor }
    }
  )), /* @__PURE__ */ React2__default.default.createElement("button", { className: "bg-black w-[40px] text-white flex items-center justify-center rounded-full" }, /* @__PURE__ */ React2__default.default.createElement(iconsReact.IconEdit, { size: 24 })), /* @__PURE__ */ React2__default.default.createElement("button", { className: "bg-gray-900/60 w-[40px] rounded-full flex items-center justify-center text-white", onClick: onClose }, /* @__PURE__ */ React2__default.default.createElement(iconsReact.IconX, null))));
};
