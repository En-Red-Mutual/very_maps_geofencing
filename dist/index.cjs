...
function useGoogleMap() {
  invariant$1(!!React2.useContext, "useGoogleMap is React hook and requires React version 16.8+");
  var map = React2.useContext(MapContext);
...
function GoogleMapFunctional(_a) {
  ...
  var _b = React2.useState(null), map = _b[0], setMap = _b[1];
  var ref = React2.useRef(null);
  var _c = React2.useState(null), centerChangedListener = _c[0], setCenterChangedListener = _c[1];
  var _d = React2.useState(null), dblclickListener = _d[0], setDblclickListener = _d[1];
  var _e = React2.useState(null), dragendListener = _e[0], setDragendListener = _e[1];
  var _f = React2.useState(null), dragstartListener = _f[0], setDragstartListener = _f[1];
  var _g = React2.useState(null), mousedownListener = _g[0], setMousedownListener = _g[1];
  var _h = React2.useState(null), mousemoveListener = _h[0], setMousemoveListener = _h[1];
  var _j = React2.useState(null), mouseoutListener = _j[0], setMouseoutListener = _j[1];
  var _k = React2.useState(null), mouseoverListener = _k[0], setMouseoverListener = _k[1];
  var _l = React2.useState(null), mouseupListener = _l[0], setMouseupListener = _l[1];
  var _m = React2.useState(null), rightclickListener = _m[0], setRightclickListener = _m[1];
  var _o = React2.useState(null), clickListener = _o[0], setClickListener = _o[1];
  var _p = React2.useState(null), dragListener = _p[0], setDragListener = _p[1];
  ...
  return jsxRuntime.jsx("div", { id, ref, style: mapContainerStyle, className: mapContainerClassName, children: jsxRuntime.jsx(MapContext.Provider, { value: map, children: map !== null ? children : null }) });
}
React2.memo(GoogleMapFunctional);
var GoogleMap = (
  /** @class */
  function(_super) {
...
var LoadScript = (
  ...
  function(_super) {
    ...
    LoadScript2.prototype.render = function() {
      return jsxRuntime.jsxs(jsxRuntime.Fragment, { children: [jsxRuntime.jsx("div", { ref: this.check }), this.state.loaded ? this.props.children : this.props.loadingElement || jsxRuntime.jsx(DefaultLoadingElement, {})] });
    };
...
function useLoadScript(_a) {
  ...
  var _d = React2.useState(false), isLoaded = _d[0], setLoaded = _d[1];
  var _e = React2.useState(void 0), loadError = _e[0], setLoadError = _e[1];
  React2.useEffect(function trackMountedState() {
    isMounted.current = true;
    return function() {
      isMounted.current = false;
    };
  }, []);
  React2.useEffect(function applyPreventGoogleFonts() {
    if (isBrowser && preventGoogleFontsLoading) {
      preventGoogleFonts();
    }
  }, [preventGoogleFontsLoading]);
  React2.useEffect(function validateLoadedState() {
    if (isLoaded) {
  ...
  React2.useEffect(function loadScriptAndModifyLoadedState() {
    if (!isBrowser) {
      return;
    }
  ...
  var prevLibraries = React2.useRef();
  React2.useEffect(function checkPerformance() {
...
function LoadScriptNext(_a) {
  ...
  React2.useEffect(function handleOnLoad() {
    if (isLoaded && typeof onLoad === "function") {
      onLoad();
    }
  }, [isLoaded, onLoad]);
  React2.useEffect(function handleOnError() {
    if (loadError && typeof onError === "function") {
      onError(loadError);
    }
  }, [loadError, onError]);
  React2.useEffect(function handleOnUnmount() {
    return function() {
      if (onUnmount) {
        onUnmount();
      }
...
function TrafficLayerFunctional(_a) {
  ...
  var map = React2.useContext(MapContext);
  var _b = React2.useState(null), instance = _b[0], setInstance = _b[1];
  React2.useEffect(function() {
    if (instance !== null) {
      instance.setMap(map);
    }
...
React2.memo(TrafficLayerFunctional);
(
  /** @class */
  (function(_super) {
...
React2.memo(BicyclingLayerFunctional);
(
  /** @class */
  (function(_super) {
...
React2.memo(TransitLayerFunctional);
(
  /** @class */
  (function(_super) {
...
function DrawingManagerFunctional(_a) {
  ...
  var map = React2.useContext(MapContext);
  var _b = React2.useState(null), instance = _b[0], setInstance = _b[1];
  var _c = React2.useState(null), circlecompleteListener = _c[0], setCircleCompleteListener = _c[1];
  var _d = React2.useState(null), markercompleteListener = _d[0], setMarkerCompleteListener = _d[1];
  var _e = React2.useState(null), overlaycompleteListener = _e[0], setOverlayCompleteListener = _e[1];
  var _f = React2.useState(null), polygoncompleteListener = _f[0], setPolygonCompleteListener = _f[1];
  var _g = React2.useState(null), polylinecompleteListener = _g[0], setPolylineCompleteListener = _g[1];
  var _h = React2.useState(null), rectanglecompleteListener = _h[0], setRectangleCompleteListener = _h[1];
  React2.useEffect(function() {
    if (instance !== null) {
      instance.setMap(map);
    }
...
React2.memo(DrawingManagerFunctional);
(
  /** @class */
  (function(_super) {
...
function MarkerFunctional(_a) {
  ...
  var map = React2.useContext(MapContext);
  var _b = React2.useState(null), instance = _b[0], setInstance = _b[1];
  var _c = React2.useState(null), dblclickListener = _c[0], setDblclickListener = _c[1];
  var _d = React2.useState(null), dragendListener = _d[0], setDragendListener = _d[1];
  var _e = React2.useState(null), dragstartListener = _e[0], setDragstartListener = _e[1];
  var _f = React2.useState(null), mousedownListener = _f[0], setMousedownListener = _f[1];
  var _g = React2.useState(null), mouseoutListener = _g[0], setMouseoutListener = _g[1];
  var _h = React2.useState(null), mouseoverListener = _h[0], setMouseoverListener = _h[1];
  var _j = React2.useState(null), mouseupListener = _j[0], setMouseupListener = _j[1];
  var _k = React2.useState(null), rightclickListener = _k[0], setRightclickListener = _k[1];
  var _l = React2.useState(null), clickListener = _l[0], setClickListener = _l[1];
  var _m = React2.useState(null), dragListener = _m[0], setDragListener = _m[1];
  var _o = React2.useState(null), clickableChangedListener = _o[0], setClickableChangedListener = _o[1];
  var _p = React2.useState(null), cursorChangedListener = _p[0], setCursorChangedListener = _p[1];
  var _q = React2.useState(null), animationChangedListener = _q[0], setAnimationChangedListener = _q[1];
  var _r = React2.useState(null), draggableChangedListener = _r[0], setDraggableChangedListener = _r[1];
  var _s = React2.useState(null), flatChangedListener = _s[0], setFlatChangedListener = _s[1];
  var _t = React2.useState(null), iconChangedListener = _t[0], setIconChangedListener = _t[1];
  var _u = React2.useState(null), positionChangedListener = _u[0], setPositionChangedListener = _u[1];
  var _v = React2.useState(null), shapeChangedListener = _v[0], setShapeChangedListener = _v[1];
  var _w = React2.useState(null), titleChangedListener = _w[0], setTitleChangedListener = _w[1];
  var _x = React2.useState(null), visibleChangedListener = _x[0], setVisibleChangedListener = _x[1];
  var _y = React2.useState(null), zIndexChangedListener = _y[0], setZindexChangedListener = _y[1];
  React2.useEffect(function() {
    if (instance !== null) {
      instance.setMap(map);
    }
  ...
  var chx = React2.useMemo(function() {
    return children ? React2.Children.map(children, function(child) {
      if (!React2.isValidElement(child)) {
        return child;
      }
      var elementChild = child;
      return React2.cloneElement(elementChild, { anchor: instance });
    }) : null;
  }, [children, instance]);
  return jsxRuntime.jsx(jsxRuntime.Fragment, { children: chx }) || null;
}
React2.memo(MarkerFunctional);
var Marker = (
  /** @class */
  function(_super) {
    ...
    Marker2.prototype.render = function() {
      ...
      if (this.props.children) {
        children = React2.Children.map(this.props.children, function(child) {
          if (!React2.isValidElement(child)) {
            return child;
          }
          var elementChild = child;
          return React2.cloneElement(elementChild, { anchor: _this.marker });
        });
      }
...
function MarkerClustererFunctional(props) {
  ...
  var _a = React2.useState(null), instance = _a[0], setInstance = _a[1];
  var map = React2.useContext(MapContext);
  var _b = React2.useState(null), clickListener = _b[0], setClickListener = _b[1];
  var _c = React2.useState(null), clusteringBeginListener = _c[0], setClusteringBeginListener = _c[1];
  var _d = React2.useState(null), clusteringEndListener = _d[0], setClusteringEndListener = _d[1];
  var _e = React2.useState(null), mouseoutListener = _e[0], setMouseoutListener = _e[1];
  var _f = React2.useState(null), mouseoverListener = _f[0], setMouseoverListener = _f[1];
  React2.useEffect(function() {
    if (instance && onMouseOut) {
      if (mouseoutListener !== null) {
        google.maps.event.removeListener(mouseoutListener);
...
React2.memo(MarkerClustererFunctional);
(
  /** @class */
  (function(_super) {
...
function InfoBoxFunctional(_a) {
  ...
  var map = React2.useContext(MapContext);
  var _b = React2.useState(null), instance = _b[0], setInstance = _b[1];
  var _c = React2.useState(null), closeClickListener = _c[0], setCloseClickListener = _c[1];
  var _d = React2.useState(null), domReadyClickListener = _d[0], setDomReadyClickListener = _d[1];
  var _e = React2.useState(null), contentChangedClickListener = _e[0], setContentChangedClickListener = _e[1];
  var _f = React2.useState(null), positionChangedClickListener = _f[0], setPositionChangedClickListener = _f[1];
  var _g = React2.useState(null), zIndexChangedClickListener = _g[0], setZindexChangedClickListener = _g[1];
  var containerElementRef = React2.useRef(null);
  React2.useEffect(function() {
  ...
  return containerElementRef.current ? ReactDOM.createPortal(React2.Children.only(children), containerElementRef.current) : null;
}
React2.memo(InfoBoxFunctional);
(
  /** @class */
  (function(_super) {
    ...
    InfoBoxComponent2.prototype.render = function() {
      return this.containerElement ? ReactDOM.createPortal(React2.Children.only(this.props.children), this.containerElement) : null;
    };
...
var equal2 = /* @__PURE__ */ getDefaultExportFromCjs(fastDeepEqual);
var ARRAY_TYPES = [
  Int8Array,
  Uint8Array,
  Uint8ClampedArray,
...
function useGoogleMarkerClusterer(options) {
  ...
  var _a = React2.useState(null), markerClusterer = _a[0], setMarkerClusterer = _a[1];
  React2.useEffect(function() {
...
React2.memo(GoogleMarkerClusterer);
var eventMap$c = {
  onCloseClick: "closeclick",
  onContentChanged: "content_changed",
  onDomReady: "domready",
...
React2.memo(InfoWindowFunctional);
(
  /** @class */
  (function(_super) {
...
function PolylineFunctional(_a) {
  ...
  var _e = React2.useState(null), dragstartListener = _e[0], setDragstartListener = _e[1];
  var _f = React2.useState(null), mousedownListener = _f[0], setMousedownListener = _f[1];
  var _g = React2.useState(null), mousemoveListener = _g[0], setMousemoveListener = _g[1];
  var _h = React2.useState(null), mouseoutListener = _h[0], setMouseoutListener = _h[1];
  var _j = React2.useState(null), mouseoverListener = _j[0], setMouseoverListener = _j[1];
  var _k = React2.useState(null), mouseupListener = _k[0], setMouseupListener = _k[1];
  var _l = React2.useState(null), rightclickListener = _l[0], setRightclickListener = _l[1];
  var _m = React2.useState(null), clickListener = _m[0], setClickListener = _m[1];
  var _o = React2.useState(null), dragListener = _o[0], setDragListener = _o[1];
  React2.useEffect(function() {
    if (instance !== null) {
      instance.setMap(map);
    }
...
React2.memo(PolylineFunctional);
(
  /** @class */
  (function(_super) {
...
function RectangleFunctional(_a) {
  ...
  var _m = React2.useState(null), clickListener = _m[0], setClickListener = _m[1];
  var _o = React2.useState(null), dragListener = _o[0], setDragListener = _o[1];
  var _p = React2.useState(null), boundsChangedListener = _p[0], setBoundsChangedListener = _p[1];
  React2.useEffect(function() {
    if (instance !== null) {
      instance.setMap(map);
    }
...
React2.memo(RectangleFunctional);
(
  /** @class */
  (function(_super) {
...
function CircleFunctional(_a) {
  ...
  var _m = React2.useState(null), clickListener = _m[0], setClickListener = _m[1];
  var _o = React2.useState(null), dragListener = _o[0], setDragListener = _o[1];
  var _p = React2.useState(null), centerChangedListener = _p[0], setCenterChangedListener = _p[1];
  var _q = React2.useState(null), radiusChangedListener = _q[0], setRadiusChangedListener = _q[1];
  React2.useEffect(function() {
    if (instance !== null) {
      instance.setMap(map);
    }
...
function DataFunctional(_a) {
  ...
  var _b = React2.useState(null), instance = _b[0], setInstance = _b[1];
  var _c = React2.useState(null), dblclickListener = _c[0], setDblclickListener = _c[1];
  var _d = React2.useState(null), mousedownListener = _d[0], setMousedownListener = _d[1];
  var _e = React2.useState(null), mousemoveListener = _e[0], setMousemoveListener = _e[1];
  var _f = React2.useState(null), mouseoutListener = _f[0], setMouseoutListener = _f[1];
  var _g = React2.useState(null), mouseoverListener = _g[0], setMouseoverListener = _g[1];
  var _h = React2.useState(null), mouseupListener = _h[0], setMouseupListener = _h[1];
  var _j = React2.useState(null), rightclickListener = _j[0], setRightclickListener = _j[1];
  var _k = React2.useState(null), clickListener = _k[0], setClickListener = _k[1];
  var _l = React2.useState(null), addFeatureListener = _l[0], setAddFeatureListener = _l[1];
  var _m = React2.useState(null), removeFeatureListener = _m[0], setRemoveFeatureListener = _m[1];
  var _o = React2.useState(null), removePropertyListener = _o[0], setRemovePropertyListener = _o[1];
  var _p = React2.useState(null), setGeometryListener = _p[0], setSetGeometryListener = _p[1];
  var _q = React2.useState(null), setPropertyListener = _q[0], setSetPropertyListener = _q[1];
  React2.useEffect(function() {
    if (instance !== null) {
      instance.setMap(map);
    }
...
function OverlayViewFunctional(_a) {
  ...
  var map = React2.useContext(MapContext);
  var container = React2.useMemo(function() {
    var div = document.createElement("div");
    div.style.position = "absolute";
    return div;
  }, []);
  var overlay = React2.useMemo(function() {
...
React2.memo(OverlayViewFunctional);
(
  /** @class */
  (function(_super) {
    ...
    function OverlayView2(props) {
      ...
      _this.containerRef = React2.createRef();
    ...
    OverlayView2.prototype.render = function() {
      ...
      if (paneEl) {
        return ReactDOM__namespace.createPortal(jsxRuntime.jsx("div", { ref: this.containerRef, style: this.state.containerStyle, children: React2.Children.only(this.props.children) }), paneEl);
      } else {
        return null;
      }
    };
...
function GroundOverlayFunctional(_a) {
  ...
  var groundOverlay = React2.useMemo(function() {
...
React2.memo(GroundOverlayFunctional);
(
  /** @class */
  (function(_super) {
...
React2.memo(HeatmapLayerFunctional);
(
  /** @class */
  (function(_super) {
...
(
  ...
  (function(_super) {
    ...
    function StandaloneSearchBox2() {
      var _this = _super !== null && _super.apply(this, arguments) || this;
      _this.registeredEvents = [];
      _this.containerElement = React2.createRef();
      _this.state = {
        searchBox: null
      };
    ...
    StandaloneSearchBox2.prototype.render = function() {
      return jsxRuntime.jsx("div", { ref: this.containerElement, children: React2.Children.only(this.props.children) });
    };
...
(
  ...
  (function(_super) {
    ...
    Autocomplete2.prototype.render = function() {
      return jsxRuntime.jsx("div", { ref: this.containerElement, className: this.props.className, children: React2.Children.only(this.props.children) });
    };
...
var Map = ({ geofences = [], zoom = 15, mode = "view", height = "60vh", onGeofenceCreate }) => {
  ...
  return /* @__PURE__ */ React2__default.default.createElement(LoadScript, { googleMapsApiKey: "AIzaSyDFuE_-2cXmeOlWIW3AvirBif1UqvMyn-U" }, /* @__PURE__ */ React2__default.default.createElement(
    GoogleMap,
    {
