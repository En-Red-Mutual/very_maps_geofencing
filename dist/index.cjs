...
var MapOverlay = ({ position, children }) => {
  const map = reactGoogleMaps.useMap();
...
var DrawingManagerComp = ({
  ...
  const map = reactGoogleMaps.useMap();
  const drawing = reactGoogleMaps.useMapsLibrary("drawing");
  React2.useEffect(() => {
...
function GeofenceMap({
  ...
  const [cameraCenter, setCameraCenter] = React2.useState(
    () => {
  ...
  return /* @__PURE__ */ React2__default.default.createElement("div", { style: { height, width } }, /* @__PURE__ */ React2__default.default.createElement(
    reactGoogleMaps.Map,
    {
      center: cameraCenter,
      zoom: zoomLevel,
    ...
    mode === "view" && dynamicRates && dynamicRates.map((rate, index) => /* @__PURE__ */ React2__default.default.createElement(React2__default.default.Fragment, { key: index }, rate.polygons && rate.polygons.length > 0 && /* @__PURE__ */ React2__default.default.createElement(
      ViewPolygon,
      {
        paths: rate.polygons,
        options: {
    ...
    ), zoomLevel > 13 && rate.polygons && rate.polygons.length > 0 && /* @__PURE__ */ React2__default.default.createElement(MapOverlay, { position: getPolygonCenter(rate.polygons) }, /* @__PURE__ */ React2__default.default.createElement(
      "div",
      {
    ...
    )), selectedGeofence && selectedGeofence.polygons && selectedGeofence.polygons.length > 0 && /* @__PURE__ */ React2__default.default.createElement(
      MapOverlay,
      {
    ...
    mode === "edit" && singlePolygon && singlePolygon.polygons.length > 0 && /* @__PURE__ */ React2__default.default.createElement(
      EditPolygon,
      {
        paths: singlePolygon.polygons,
...
var InputSearch = ({
  ...
  const places = reactGoogleMaps.useMapsLibrary("places");
  const customCSS = [];
