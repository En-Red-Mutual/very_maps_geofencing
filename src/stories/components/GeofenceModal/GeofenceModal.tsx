    ...
    return (
        <article className='w-[200px] flex flex-col gap-2'>
            ...
            <div className='bg-black py-2 text-white rounded-[1.5rem] text-center flex flex-col gap-1'>
                <h2 className='font-bold text-[13px]'>Tarifa dinámica</h2>
            ...
            <div className='flex gap-1 justify-between h-[40px] w-full'>
                ...
                <div className='bg-black p-1 rounded-full flex items-center'>
                    <div
                        className='w-[30px] h-[30px] rounded-full'
                        style={{ backgroundColor: geofence.geofenceColor }}
                    />
                </div>
                <button className='bg-black w-[40px] text-white flex items-center justify-center rounded-full'>
                    <IconEdit size={24} />
                </button>
                <button className='bg-gray-900/60 w-[40px] rounded-full flex items-center justify-center text-white' onClick={onClose}>
                    <IconX />
                </button>
            </div>
        </article>
